...
{
    "location": "precisions/#available-precision-1",
    "page": "Precisions",
...
{
    "location": "precisions/#operating-precision-1",
    "page": "Precisions",
    "title": "operating precision",
    "category": "section",
    "text": "For some numerical work, it is necessary that all significant bits/digits of each value computed be visible.  This is especially true with algorithmic development, precision-sensitive analysis, and delivery of numerical assurances.This mode of use obtains with an initial directive: setextrabits(0)."
},

{
    "location": "precisions/#perceptual-precision-1",
    "page": "Precisions",
...
{
    "location": "precisions/#ArbFloat-1",
    "page": "Precisions",
    "title": "ArbFloat",
    "category": "section",
    "text": "It is reasonable to use settings of {32, 48, or 64} with ArbFloats.With ArbFloat, the extra bits serve to pad away some numerical noise that otherwise could accumulate as uncertainty or opacity. When using ArbFloats in an ill-conditioned calculation, consider raising this setting – you will see the same number of digits, the internal precision will have increased."
},

{
    "location": "precisions/#ArbReal,-ArbComplex-1",
    "page": "Precisions",
    "title": "ArbReal, ArbComplex",
    "category": "section",
    "text": "It is reasonable to use settings of {64, 96, 128} with ArbReal, and {64, 128, 196} with ArbComplex.With ArbReal and ArbComplex, the extra bits serve to extend the proper intelligebility of the midpoint within an enclosure. Enclosures are given as a pair: midpoint, radius, called a ball. When the radius is quite small relative to the position of the midpoint, then the midpoint itself is a better reflection of the enclosed true or the theoretical best value.  Increasing the extrabits serves to push the radius farther \"down\" along the midpoint (as it were), which, at least temporarily, makes it more resiliant to gross widening."
},
...

{
    ...
    "category": "section",
    "text": "The input values have no memory of the precision that was used to create them. An input value could be,    [1.0 +/- 0.25], irrespective of the precision used to compute it – was it 2 bits, 100 or 1_000 bits.Just think of a ball as a pair of rational numbers, not in terms of precision. The precision p for the new operation specifies ... that the midpoint of the output ball is to be rounded to at most p bits; if p = 100 then the output will be rounded to at most 100 bits even if the inputs have 1000000 bits.– Fredrik Johansson on nemo-dev, 2018-Dec-05"
},
